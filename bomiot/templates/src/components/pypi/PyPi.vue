...
const columns = computed( () => [
  { name: 'category', required: true, label: t('pypi.category'), align: 'left', field: 'category'},
  { name: 'downloads', align: 'center', label: t('pypi.downloads'), field: 'downloads' },
  { name: 'percent', align: 'center' ,label: t('pypi.percent'), field: 'percent' },
  { name: 'date', align: 'center', label: t('pypi.date'), field: 'date' },
])
