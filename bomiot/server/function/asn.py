...
class ASNList(ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return models.ASN.objects.filter(**query_data).order_by(ordering)
...
class ASNCreate(ModelViewSet):
    ...
    ordering_fields = ['id', "created_time", "updated_time", ]
    filter_class = filter.ASNFilter
    queryset = models.ASN.objects.filter(is_delete=False)
