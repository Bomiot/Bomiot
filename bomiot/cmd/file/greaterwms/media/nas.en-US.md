...
![image-01](/media/img/nas1.png){ loading=lazy }
...
![image-02](/media/img/nas2.png){ loading=lazy }
...
![image-03](/media/img/nas3.png){ loading=lazy }
...
![image-04](/media/img/nas4.png){ loading=lazy }
...
![image-05](/media/img/nas5.png){ loading=lazy }
...
![image-06](/media/img/nas6.png){ loading=lazy }

![image-07](/media/img/nas7.png){ loading=lazy }
...
![image-08](/media/img/nas8.png){ loading=lazy }
...
![image-09](/media/img/nas9.png){ loading=lazy }

> 找到 server 127.0.0.1:8008;

![image-10](/media/img/nas10.png){ loading=lazy }

> 改为 server 192.168.0.197:8285;

![image-11](/media/img/nas11.png){ loading=lazy }
...
![image-12](/media/img/nas12.png){ loading=lazy }

> 看到两个 done 就完成了

![image-13](/media/img/nas13.png){ loading=lazy }

#### 可以进群晖的容器看一下状态

> 前端内存占用多，后端CPU占用高，而且一直都比较稳定；

![image-14](/media/img/nas14.png){ loading=lazy }
...
![image-15](/media/img/nas15.png){ loading=lazy }

> 编译完成

![image-16](/media/img/nas16.png){ loading=lazy }

> 我们可以在 /docker/GreaterWMS/templates/dist/spa 中看到生成的前端代码

![image-17](/media/img/nas17.png){ loading=lazy }
...
![image-18](/media/img/nas18.png){ loading=lazy }
...
![image-19](/media/img/nas19.png){ loading=lazy }

> 前端要看到 ℹ ｢wds｣: Project is running at http://0.0.0.0:8080/

![image-20](/media/img/nas20.png){ loading=lazy }

> 现在可以开始访问了，在浏览器中输入 http://群晖IP:8285 或者 http://群晖IP:8286都是能看到主界面的，所不同的是，从 8285 打开的话，右下角有个绿色的 vConsole 按钮，感觉像是调试用的

![image-21](/media/img/nas21.png){ loading=lazy }

> 首先注册一个管理员账号，完成后就是主界面了

![image-22](/media/img/nas22.png){ loading=lazy }

> 功能就留个需要的人自己研究吧

![image-23](/media/img/nas23.png){ loading=lazy }
