...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'customer', component: () => import('pages/base/CustomerReader.vue') },
      { path: 'bin', component: () => import('pages/base/BinReader.vue') },
      { path: 'goods', component: () => import('pages/base/GoodsReader.vue') },
      { path: 'dnlist', component: () => import('pages/outbound/DNListReader.vue') },
      { path: 'dndetail', component: () => import('pages/outbound/DNDetailReader.vue') },
      { path: 'asnlist', component: () => import('pages/inbound/ASNReader.vue') },
      { path: 'asndetail', component: () => import('pages/inbound/ASNDetailReader.vue') },
      { path: 'stock', component: () => import('pages/inventory/StockListReader.vue') },
      { path: 'stockbin', component: () => import('pages/inventory/StockBinReader.vue') },
      ...
      { path: 'dev-be-language', component: () => import('pages/dev/LanguageReader.vue') },
