...
const menuLinks = computed(() => [
  ...
  { tab: 'standard', title: t('customer.name'), icon: 'contact_phone', link: '/customer' },
  { tab: 'standard', title: t('bin.name'), icon: 'pallet', link: '/bin' },
  { tab: 'standard', title: t('goods.name'), icon: 'inventory_2', link: '/goods' },
  ...
  { tab: 'inbound', title: t('asn.name'), icon: 'img:statics/icons/asnlist.svg', link: '/asnlist' },
  { tab: 'inbound', title: t('asn.detail'), icon: 'content_paste_search', link: '/asndetail' },
  { tab: 'outbound', title: t('dn.name'), icon: 'img:statics/icons/dnlist.svg', link: '/dnlist' },
  { tab: 'outbound', title: t('dn.detail'), icon: 'list_alt', link: '/dndetail' },
  { tab: 'inventory', title: t('inventory.list'), icon: 'img:statics/icons/stock.svg', link: '/stock' },
  { tab: 'inventory', title: t('inventory.bin'), icon: 'img:statics/icons/stockbin.svg', link: '/stockbin' },
