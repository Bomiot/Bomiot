...
export default {
  ...
  menuLink: {
    home: 'Home',
    why_greaterwms: 'Why GreaterWMS',
    sponsors_and_supporters: 'Sponsors',
    why_donate: 'Why Donate',
    please_dont_do_that: "Don't do that",
    software_version_requirements: 'Software Version',
    server_configuration_recommendations: 'Server Configuration',
    win_10: 'Win10 X64',
    centos7_x64_bit: 'Centos 7 Deploy',
    ubuntu20_x64: 'Ubuntu 20 Deploy',
    ios_environment: 'IOS Environment',
    android_environment: 'Android Environment',
    android_sign: 'Android Sign',
    quasar_framework: 'Quasar Framework',
    supervisor_process_guarded: 'Supervisor Process',
    nginx_config: 'Nginx Config',
    docker_deployment: 'Docker Deploy',
    nas: 'Synology Nas',
    windows: 'Windows',
    ios: 'IOS',
    android: 'Android',
